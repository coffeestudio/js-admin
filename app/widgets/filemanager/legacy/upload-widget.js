define(["require", "exports", 'jquery', "../../../components/jquery-form/jquery.form"], function (require, exports, $) {
    $.fn.extend({
        uploadWidget: function (options) {
            var defaults = { action: '', slot: 'file', multiple: true, callback: function () {
            }, before: function () {
            }, init: function () {
            } };
            ...
            return this.each(function () {
                ...
                inp.change(function () {
                    $(this.form).ajaxSubmit({ dataType: 'json', success: options.callback, beforeSubmit: options.before, beforeSerialize: options.init, clearForm: true });
                });
                ...
                btn.mouseover(function () {
                    newfrm.show(0);
                    newfrm.offset(btn.offset());
                });
                newfrm.mouseout(function () {
                    newfrm.hide(0);
                });
            });
        }
